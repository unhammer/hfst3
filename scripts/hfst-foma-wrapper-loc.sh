#!/bin/bash
#
# This file is copied from file hfst-foma-wrapper.sh.in.
# Instead of calling @prefix@/hfst_foma, 
# this script calls ../back-ends/hfst_foma.
#
foma_exec=`dirname $(readlink -f $0)`/../back-ends/foma/hfst_foma
if [ ! -x $foma_exec ] ; then
