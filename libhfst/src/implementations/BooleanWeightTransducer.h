...
#ifndef _BOOLEAN_WEIGHT_TRANSDUCER_H_
#define _BOOLEAN_WEIGHT_TRANSDUCER_H_
...
/** @file BooleanWeightTransducer.h
    \brief Declarations of functions and datatypes that form a bridge between
    HFST API and OpenFst's transducers with boolean weights. */
...
namespace implementations
{
  ...
  class BooleanWeightInputStream 
  {
  private:
    std::string filename;
    ifstream i_stream;
  ...
  public:
    BooleanWeightInputStream(void);
    BooleanWeightInputStream(const std::string &filename);
    void close(void);
  ...
  class BooleanWeightOutputStream 
  {
  private:
    std::string filename;
    ofstream o_stream;
  ...
  public:
    BooleanWeightOutputStream(bool hfst_format=true); 
    BooleanWeightOutputStream
  ...
  /*class BooleanWeightTransitionIterator;

  typedef StateId BooleanWeightState;

  class BooleanWeightStateIterator 
    {
    protected:
      StateIterator<StdVectorFst> * iterator;
    public:
      BooleanWeightStateIterator(StdVectorFst * t);
      ~BooleanWeightStateIterator(void);
      void next(void);
      bool done(void);
      BooleanWeightState value(void);
    };
 

  class BooleanWeightTransition
    {
    protected:
      StdArc arc;
      StdVectorFst * t;
    public:
      BooleanWeightTransition(const StdArc &arc, StdVectorFst *t);
      ~BooleanWeightTransition(void);
      std::string get_input_symbol(void) const;
      std::string get_output_symbol(void) const;
      BooleanWeightState get_target_state(void) const;
      BooleanWeight get_weight(void) const;
    };
  ...
  class BooleanWeightTransitionIterator
    ...
    protected:
      ...
      StdVectorFst * t;
    public:
      BooleanWeightTransitionIterator(StdVectorFst * t, StateId state);
      ~BooleanWeightTransitionIterator(void);
      void next(void);
      bool done(void);
      BooleanWeightTransition value(void);
    };
  */

  class BooleanWeightTransducer
    {
    public:
    ...
    public:
      ...
      static bool is_final(StdVectorFst *t, StateId s);
