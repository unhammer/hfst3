...
namespace hfst { namespace implementations
{
  ...
  (fst::StdVectorFst * t, HfstBasicTransducer * net, bool has_hfst_header)
  {
    ...
    /* An HFST boolean transducer always has an input symbol table. */
  ...
  /* ------------------------------------------------------------------------
     ...
     Create an HfstBasicTransducer equivalent to an OpenFst boolean weight
     transducer \a t. 

     ------------------------------------------------------------------------ */  

  HfstBasicTransducer * ConversionFunctions::
  boolean_ofst_to_hfst_basic_transducer
  (fst::StdVectorFst * t, bool has_hfst_header) {
    ...
    StringVector symbol_vector = BooleanWeightTransducer::get_symbol_vector(t);
  ...
  hfst_basic_transducer_to_boolean_ofst
