...
#ifndef _MFSTL_TRANSDUCER_H_
#define _MFSTL_TRANSDUCER_H_
...
{
  /* If library MFSTL is written in namespace mfstl, it must be visible
  ...
  /** @brief A class for reading binary MyFsts from a stream. 
     ...
     in class MfstlInputStream. If your transducer read function uses C++ streams,
  ...
  /* A class for writing binary MyFsts to a stream. 
     ...
     in class MfstlOutputStream. If your transducer write function uses C++ streams,
