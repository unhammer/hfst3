...
namespace hfst
{
  ...
  typedef unsigned int Character;
    ...
    public:
      ...
      void insert(NumberPair sp) { /* check special symbols */ pairs.insert(sp); };
      void clear_pairs() { pairs.clear(); };
      
      int symbol2code( const char * ) const { return EOF; };
      const char *code2symbol( Character ) const { return NULL; };
    };
    ...
    public:
      ...
      static bool in_range( unsigned int c, Range *r ) { return false; };
      static unsigned int utf8toint( char * ); //{ return EOF; };
      static char* fst_strdup(const char* ) { return NULL; };
